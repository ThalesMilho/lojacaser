...
export const SET_PRODUCT_VARIANT_SIZE = 'src/Product/SET_PRODUCT_VARIANT_SIZE';
export const SET_PRODUCT_VARIANT_COLOR = 'src/Product/SET_PRODUCT_VARIANT_COLOR';
